...
def show_prediction_form(modelo, engine):
    """Formulário de predição para estudantes"""
    ...
    if submit_button:
        ...
        try:
            ...
            data_to_save = pd.DataFrame([{
                ...
                'user_submitting': st.session_state.username,
                'curso': curso,
                ...
                'prediction_label': int(risco_label),
                'prediction_score': float(probabilidade_risco)
            }])
